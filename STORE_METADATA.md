# Gezgin Günlüğü - App Store & Google Play Mağaza Hazırlık Rehberi

## 📱 Mağaza Bilgileri
- **Uygulama Adı:** Gezgin Günlüğü
- **Bundle ID (iOS):** `com.serkanadak.gezgingunlugu`
- **Package Name (Android):** `com.serkanadak.gezgingunlugu`
